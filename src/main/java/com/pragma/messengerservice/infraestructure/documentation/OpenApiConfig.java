package com.pragma.messengerservice.infraestructure.documentation;
...
public class OpenApiConfig {
    ...
    public OpenAPI openApiConfiguration() {
        ...
        var exceptionSchema = new Schema<Map<String, String>>()
                .addProperty("message", new StringSchema().example("twilio error"));

        return new OpenAPI()
                .info(new Info()
                        .title("Microservice Messenger hexagonal")
